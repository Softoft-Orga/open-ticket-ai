...
from open_ticket_ai.open_ticket_ai.base import OTOBOAdapter
...
from open_ticket_ai.open_ticket_ai.core.ticket_system_integration.unified_models import TicketSearchCriteria, UnifiedQueue
