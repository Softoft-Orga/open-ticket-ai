...
from .configurable_pipe_config import RawPipeConfig, RenderedPipeConfig
from .context import PipelineContext
from ..config.raw_config import RenderableConfig
from ..config.registerable import RegisterableClass


class ConfigurablePipe[RawPipeConfigT: RawPipeConfig, RenderedPipeConfigT: RenderedPipeConfig](
    BasePipe[RawPipeConfigT, RenderedPipeConfigT], abc.ABC
):
    def __init__(
            self, config: RenderableConfig[RawPipeConfigT, RenderedPipeConfigT], *args: Any, **kwargs: Any
    ) -> None:
