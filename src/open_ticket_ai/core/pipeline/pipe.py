...
from ...extensions.pipe_implementations.simple_key_value_mapper import ConfigT


class Pipe(Generic[ConfigT], ABC):
    ...
    async def _process(self, context: PipelineContext) -> Dict[str, Any]:
        """
        Process the pipeline context. Must be implemented by subclasses.
        
        Args:
            context: The current pipeline context
            
        Returns:
            Dictionary containing the pipe's output state
        """
        pass
