...
This reference provides the complete schema for Open Ticket AI configuration files, auto-generated from the Python Pydantic models. For practical examples and usage patterns, see the [Configuration Examples](configuration/examples.md).
...
See [Python logging.config documentation](https://docs.python.org/3/library/logging.config.html#logging-config-dictschema) for complete reference.
