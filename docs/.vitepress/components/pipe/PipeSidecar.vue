    ...
    <div class="pipe-sidecar bg-vp-bg-soft border border-vp-border rounded-lg overflow-hidden">
        ...
        <div class="p-6 space-y-6">
                        ...
                        <table class="w-full text-xs">
                            <tbody>
                                <tr v-for="(example, state) in sidecar._output.examples" :key="state" class="border-b border-vp-border">
                                    ...
                                    <td class="py-2"><pre class="text-xs">{{ JSON.stringify(example, null, 2) }}</pre></td>
                                </tr>
                            </tbody>
                        </table>
                    </AccordionItem>
            ...
            <section>
                ...
                <div class="space-y-3">
                    <div v-for="(errors, type) in errorsByType" :key="type" class="border rounded-lg p-3" :class="getErrorClass(type)">
