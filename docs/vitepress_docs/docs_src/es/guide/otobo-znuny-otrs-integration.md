---
description: Integra Python con OTOBO, Znuny y OTRS usando una librería de cliente asíncrona. Esta guía proporciona ejemplos de código para gestionar tickets de helpdesk a través de la API REST.
---
