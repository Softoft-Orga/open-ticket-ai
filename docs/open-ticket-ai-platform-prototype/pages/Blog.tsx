          ...
          <div className="grid gap-16 lg:grid-cols-2 lg:items-center">
            <div className="flex flex-col gap-8">
              ...
              <h1 className="font-display text-5xl font-bold leading-tight tracking-tight text-white lg:text-7xl">
                Renaming Open Ticket AI to <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary to-primary-light">Open Ticket Automation</span>
              </h1>
              <p className="text-xl text-gray-400 max-w-xl leading-relaxed">
                We are rebranding to reflect our shift towards full-cycle autonomous resolution. Discover how our new identity aligns with our mission to eliminate Tier 1 support tickets.
              </p>
              <div className="flex flex-wrap gap-4 pt-4">
                <button className="group flex h-14 items-center justify-center gap-3 rounded-lg bg-white px-8 text-lg font-bold text-background-dark transition-transform hover:-translate-y-1">
                  Read Announcement
                  <span className="material-symbols-outlined text-2xl transition-transform group-hover:translate-x-1">arrow_forward</span>
                </button>
                <button className="flex h-14 items-center justify-center rounded-lg border border-surface-lighter px-8 text-lg font-bold text-white transition-colors hover:bg-surface-lighter hover:border-primary/50">
                  View Press Kit
                </button>
              </div>
            </div>
              ...
              <div className="absolute bottom-8 left-8 right-8">
                <div className="flex items-center justify-between text-sm text-gray-300">
                  <span className="flex items-center gap-2">
                    <span className="material-symbols-outlined text-lg">calendar_today</span> Oct 24, 2023
                  </span>
                  <span className="flex items-center gap-2">
                    <span className="material-symbols-outlined text-lg">schedule</span> 5 min read
                  </span>
                </div>
              </div>
            </div>
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-24">
        <div className="flex flex-col lg:flex-row gap-16">
          ...
          <aside className="w-full lg:w-80 flex-shrink-0 space-y-12">
            ...
            <div>
              ...
              <nav className="space-y-2">
                <TopicLink icon="grid_view" label="All Posts" count={42} active />
                <TopicLink icon="rocket_launch" label="Product Updates" />
                <TopicLink icon="code" label="Engineering" />
                <TopicLink icon="lightbulb" label="Use Cases" />
                <TopicLink icon="security" label="Security" />
              </nav>
            </div>

            <div className="rounded-2xl border border-surface-lighter bg-surface-dark p-8">
              <div className="mb-6 flex size-12 items-center justify-center rounded-xl bg-primary/20 text-primary">
                <span className="material-symbols-outlined text-3xl">mail</span>
              </div>
              <h3 className="mb-3 font-display text-xl font-bold text-white">Stay in the loop</h3>
              <p className="mb-6 text-sm text-text-dim">Get the latest on AI automation and engineering straight to your inbox.</p>
          ...
          <div className="flex-1">
            <div className="mb-12 flex items-end justify-between border-b border-surface-lighter pb-6">
              <h2 className="font-display text-3xl font-bold text-white">Latest Articles</h2>
              <div className="flex items-center gap-2">
                <span className="text-sm text-text-dim">Sort by:</span>
                <select className="rounded border-none bg-transparent py-0 pl-2 pr-10 text-sm font-medium text-white focus:ring-0 cursor-pointer">
            ...
            <div className="grid gap-8 md:grid-cols-2">
              ...
              <ArticleCard
                ...
                desc="Our latest NLP models now handle complex German compound nouns with 99.8% accuracy."
              ...
              <ArticleCard
                ...
                title="The Future of Autonomous Helpdesk"
                date="Oct 05"
                img="https://picsum.photos/400/250?4"
                desc="Why hybrid AI-human workflows are the inevitable standard for enterprise support."
              />
            </div>
          </div>
        </div>
