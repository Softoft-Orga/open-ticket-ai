    ...
    <div class="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
      ...
      <nav class="hidden md:flex flex-1 justify-center gap-8 text-sm font-medium">
        ...
        <Menu as="div" class="relative">
          <MenuButton class="flex items-center gap-1 text-gray-400 hover:text-white transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-primary/60 rounded-lg px-2 py-1">
            Docs
            <ChevronDownIcon class="h-4 w-4 transition-transform ui-open:rotate-180 ui-open:text-white" />
          </MenuButton>
              ...
              <MenuItems class="absolute left-1/2 -translate-x-1/2 mt-3 w-72 rounded-2xl border border-surface-lighter bg-[#11011c] shadow-2xl backdrop-blur-xl p-4 focus:outline-none">
                <div class="space-y-4">
                  <div>
                    ...
                    <MenuItem v-slot="{ active }">
                      <a
                        :href="docsHub.href"
                        :class="[
                          'mt-3 flex gap-3 rounded-xl border border-surface-lighter/60 bg-slate-900/60 px-3 py-2 text-left text-white transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-primary/40',
                          active && 'border-surface-lighter bg-surface-dark'
                        ]"
                      >
                  ...
                  <div>
                    ...
                    <MenuItem v-for="link in docsProductLinks" :key="link.href" v-slot="{ active }">
                      <a
                        :href="link.href"
                        :class="[
                          'mt-3 flex gap-3 rounded-xl border border-surface-lighter/60 bg-slate-900/60 px-3 py-2 text-left text-white transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-primary/40',
