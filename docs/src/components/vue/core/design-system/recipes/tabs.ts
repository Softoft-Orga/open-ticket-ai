  ...
  variants: {
    style: {
      underline: {
        ...
        trigger:
          'border-b-2 border-transparent hover:text-text-1 data-[selected]:border-current data-[selected]:text-current',
        panel: '',
      },
      pill: {
        list: 'bg-surface-dark p-1 rounded-xl',
        trigger:
          'rounded-lg hover:bg-surface-lighter data-[selected]:bg-surface-lighter data-[selected]:text-current',
        panel: '',
      },
    },
    tone: {
