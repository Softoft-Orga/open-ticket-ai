...
dumb classifier that _always_ predicts A achieves 80% accuracy by default – yet it completely
...
- **Subset Accuracy** (Exact Match) – fraction of samples where _all_ predicted labels exactly match
