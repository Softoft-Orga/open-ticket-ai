...
Zur Veranschaulichung hier einige _Dummy-Ticket-Daten_, mit denen Sie arbeiten könnten:
...
Diese Labels würden dann in die Überprüfungsoberfläche geladen werden. Selbst wenn einige falsch sind (z.B. könnte GPT einen kniffligen Bug als Feature falsch labeln), muss der Annotator sie nur _korrigieren_, anstatt von Grund auf zu beginnen. Empirisch erreichen GPT-generierte Labels oft eine Genauigkeit von \~80–90 %, sodass die Überprüfung viel schneller ist als vollständiges Labeling.
