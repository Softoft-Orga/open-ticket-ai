...
| _was_skipped_ | true/false       | Whether the pipe was skipped due to failed dependencies or conditional execution |
| _message_     | TEXT             | Human-readable message describing the result or any issues                       |
