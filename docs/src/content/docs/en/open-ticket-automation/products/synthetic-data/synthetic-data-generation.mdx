...
<div class="w-100 pt-3 bg-gray-900 rounded-lg">
  <div class="mx-auto max-w-screen-lg pb-5">
    ...
    >
      ...
      <button type="submit" class="w-full justify-center px-6 py-3 bg-primary text-white font-semibold rounded-xl hover:bg-primary-dark transition-colors">
        Join Waitlist
      </button>
    </form>
  </div>
  <p class="w-full text-xs text-center leading-3 text-gray-400 pb-3">
    We respect your privacy. Your email will only be used for this waitlist.
  </p>
</div>
