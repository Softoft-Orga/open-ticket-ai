...
<div class="my-6 p-4 border border-border-1 rounded-lg bg-surface-1">
  <div class="text-sm text-muted mb-2">Example: basics-minimal</div>
  <div class="text-text-2">
    <p class="italic">Configuration example content will be added here.</p>
  </div>
</div>
...
See the [Plugin Development Guide](../developers/plugin_development.mdx) for:
