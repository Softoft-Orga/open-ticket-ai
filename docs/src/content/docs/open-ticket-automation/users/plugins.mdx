...
---
import Alert from '../../../../components/vue/core/basic/Alert.vue';
...
<Alert type="info" title="Example Configuration">

See the **basics-minimal** configuration example for a complete workflow using plugins.
