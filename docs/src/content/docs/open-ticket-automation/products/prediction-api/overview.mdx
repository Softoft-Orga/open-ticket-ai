...
<Alert type="info" title="Interactive Demo">

Use the code examples below to test the API, or try it directly with curl:
...
curl -X POST "https://open-ticket-ai.com/api/german_prediction/v1/classify" \
  ...
  -d '{
        ...
        "body": "Kann nach dem Update keine Verbindung zum Unternehmens-VPN herstellen."
      }'
```
